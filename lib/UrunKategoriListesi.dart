...
import 'package:abiyelik/UrunDetay.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class UrunKategoriListesi extends StatefulWidget {
  final Student student;
  UrunKategoriListesi({required this.student});
  @override
  _UrunListesi createState() => _UrunListesi();
}

class _UrunListesi extends State<UrunKategoriListesi> {
